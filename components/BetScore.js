...
function BetScores({ betGameScoreData }) {
	...
	return (
		<Container fluid>
			<Row className="">
				<Col xs={"auto"} xl="auto" className="mt-2 text-secondary">
					{calendarCard}
					{gameTimeCard}
				</Col>
				<Col md={8} lg={8} xl={8} className="">
					<Row className="mb-4">
						<Col md={4} lg={4} xl={4} className="">
							<Image width={35} height={35} src={betGameScoreData.away.logo} rounded />
						</Col>
						<Col md={5} lg={5} xl={5} className="">
						...
						<Col md={3} lg={3} xl={3} className="mx-0">
							{awayScore}
						</Col>
					</Row>
