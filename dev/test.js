...
console.log("VALID: ", chalkCoin.chainIsValid(bc1.chain));

// Testing the blockchain function createNewBlock
//chalkCoin.createNewBlock(892348, 'AADSADASDDA95350', 'AJKFDAJFDAJ04R43WFSD');
// Testing the blockchain function createNewTransaction
//chalkCoin.createNewTransaction(100, 'ALEXFA54SFJ76LA', 'JENAFJA7FD345NSD');
// When there's pending transactions, you have to create a new block to push those transactions to blockchain
//chalkCoin.createNewBlock(1243242, 'DAJFDAD354FFD', 'DFJDAFDA345WFSA');
//console.log(chalkCoin);

// Testing mulitiple transactions in one block
//chalkCoin.createNewTransaction(50, 'DAJFDAD354FFD', 'DFJDAFDA345WFSA');
//chalkCoin.createNewTransaction(300, 'DAJFDAD354FFD', 'DFJDAFDA345WFSA');
//chalkCoin.createNewTransaction(2000, 'DAJFDAD354FFD', 'DFJDAFDA345WFSA');
//chalkCoin.createNewBlock(4342442, 'DFSAFJ94385RFD', 'G5T5GWRGL5GW34TGD');
// To see the blockchain's array
//console.log(chalkCoin.chain[3]);
...
//let nonce = chalkCoin.proofOfWork(previousBlockHash, currentBlockHash)
// Showing the nonce from the proofOfWork function
//console.log(chalkCoin.proofOfWork(previousBlockHash, currentBlockHash));

// Showing the hashBlock output
//console.log(chalkCoin.hashBlock(previousBlockHash, currentBlockHash, nonce));
