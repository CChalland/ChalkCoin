...
console.log("VALID: ", betoken.chainIsValid(bc1.chain));

// Testing the blockchain function createNewBlock
//betoken.createNewBlock(892348, 'AADSADASDDA95350', 'AJKFDAJFDAJ04R43WFSD');
// Testing the blockchain function createNewTransaction
//betoken.createNewTransaction(100, 'ALEXFA54SFJ76LA', 'JENAFJA7FD345NSD');
// When there's pending transactions, you have to create a new block to push those transactions to blockchain
//betoken.createNewBlock(1243242, 'DAJFDAD354FFD', 'DFJDAFDA345WFSA');
//console.log(betoken);

// Testing mulitiple transactions in one block
//betoken.createNewTransaction(50, 'DAJFDAD354FFD', 'DFJDAFDA345WFSA');
//betoken.createNewTransaction(300, 'DAJFDAD354FFD', 'DFJDAFDA345WFSA');
//betoken.createNewTransaction(2000, 'DAJFDAD354FFD', 'DFJDAFDA345WFSA');
//betoken.createNewBlock(4342442, 'DFSAFJ94385RFD', 'G5T5GWRGL5GW34TGD');
// To see the blockchain's array
//console.log(betoken.chain[3]);
...
//let nonce = betoken.proofOfWork(previousBlockHash, currentBlockHash)
// Showing the nonce from the proofOfWork function
//console.log(betoken.proofOfWork(previousBlockHash, currentBlockHash));

// Showing the hashBlock output
//console.log(betoken.hashBlock(previousBlockHash, currentBlockHash, nonce));
